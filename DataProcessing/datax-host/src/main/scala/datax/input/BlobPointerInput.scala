...
=======
  private val saRegex = s"""(wasbs?|abfs?)://[a-zA-Z0-9-_]+@([a-zA-Z0-9-_]+)(${BlobProperties.BlobHostPath}||${BlobProperties.DfsHostPath})/.*""".r
>>>>>>> add abfss protocol for adls gen2 experiment
