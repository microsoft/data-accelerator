...
class FlowDefinitionPanel extends React.Component {
    ...
    componentWillUnmount() {
        ...
        if (this.props.kernelId !== undefined && this.props.kernelId !== '') {
            this.onDeleteKernel(this.props.kernelId, this.props.flow.databricksToken);
        }
    }
    ...
    deleteAllKernel() {
        this.props.onDeleteAllKernels(QueryActions.updateErrorMessage, this.props.flow.databricksToken);
    }

    onDeleteKernel(kernelId, databricksToken) {
        const version = this.props.kernelVersion + 1;
        this.props.onUpdateKernelVersion(version);
        return this.props.onDeleteKernel(kernelId, version, databricksToken);
    }
...
const mapDispatchToProps = dispatch => ({
    ...
    onDeleteKernel: (kernelId, version, databricksToken) => dispatch(KernelActions.deleteKernel(kernelId, version, databricksToken)),
    ...
    onDeleteAllKernels: (updateErrorMessage, databricksToken) => dispatch(KernelActions.deleteAllKernels(updateErrorMessage, databricksToken)),
